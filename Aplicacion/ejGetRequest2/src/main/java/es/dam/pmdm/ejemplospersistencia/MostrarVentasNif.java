...
public class MostrarVentasNif extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mostrarventasnif);
        ...
        filtrar.setOnClickListener(this::getVentasNif);
    ...
    public void getVentasNif(View view) {
        String NIF = nif.getText().toString();
        Call<List<Ventas>> call = jsonPlaceHolderApi.getVentasNif(NIF);
        ...
        call.enqueue(new Callback<List<Ventas>>() {
            ...
            public void onResponse(Call<List<Ventas>> call, Response<List<Ventas>> response) {
                ...
                if (!response.isSuccessful()) {
                    MostrarVentasNif.this.view.setText("Code: " + response.code());
                    return;
                }
